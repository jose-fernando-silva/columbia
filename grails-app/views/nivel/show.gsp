	...
	<body>
		...
		<div id="show-nivel" class="content scaffold-show" role="main">
			...
			<ol class="property-list nivel">
				...
				<g:if test="${nivelInstance?.grado}">
				<li class="fieldcontain">
					<span id="grado-label" class="property-label"><g:message code="nivel.grado.label" default="Grado" /></span>
					
						<span class="property-value" aria-labelledby="grado-label"><g:fieldValue bean="${nivelInstance}" field="grado"/></span>
