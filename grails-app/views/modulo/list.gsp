	...
	<body>
		...
		<div id="list-modulo" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="dia" title="${message(code: 'modulo.dia.label', default: 'Dia')}" />
					
						<g:sortableColumn property="hora" title="${message(code: 'modulo.hora.label', default: 'Hora')}" />
				...
				<g:each in="${moduloInstanceList}" status="i" var="moduloInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${moduloInstance.id}">${fieldValue(bean: moduloInstance, field: "dia")}</g:link></td>
					
						<td>${fieldValue(bean: moduloInstance, field: "hora")}</td>
			...
			<div class="pagination">
				<g:paginate total="${moduloInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
