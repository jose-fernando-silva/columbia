			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="username" title="${message(code: 'profesor.username.label', default: 'Username')}" />
				...
				<g:each in="${profesorInstanceList}" status="i" var="profesorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${profesorInstance.id}">${fieldValue(bean: profesorInstance, field: "username")}</g:link></td>
