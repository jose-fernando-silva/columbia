...
<html>
	...
	<body>
		...
		<div id="status" role="complementary">
			...
			<div id="menu">
				<ul>
					<li><g:link controller='reporte'>Reportes</g:link></li>
					<li><g:link controller='conducta'>Conducta de alumnos</g:link></li>
					<li><g:link controller='avisos'>Avisos</g:link></li>
