...
<html>
	...
	<body>
		...
		<div id="status" role="complementary">
			<h1 style="font-size: 20px;font-weight: bold;">Seleccion a aun hijo:</h1>

			<g:form action="index" >
				<div class="fieldcontain ${hasErrors(bean: alumnoInstance, field: 'tutor', 'error')} required">
					<g:select id="hijo" name="hijo" from="${hijos}" optionKey="id" required=""/>
				</div>
				<br>
