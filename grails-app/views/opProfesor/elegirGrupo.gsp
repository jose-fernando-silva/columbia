...
<html>
	...
	<body>
		...
		<div id="status" role="complementary">
			<h1 style="font-size: 20px;font-weight: bold;">Selecciona grupo a evaluar:</h1>

			<g:form action="elegirBimestre" >
				<div class="fieldcontain ${hasErrors(bean: alumnoInstance, field: 'tutor', 'error')} required">
					<g:select id="grupo" name="grupo" from="${grupos}" optionKey="id" required=""/>
				</div>
				<br>
