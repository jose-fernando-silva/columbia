...
<html>
	<head>
		...
		<title>Seleccionar Bimestre</title>
	...
	<body>
		...
		<div id="status" role="complementary">
			<h1 style="font-size: 20px;font-weight: bold;">Selecciona en que bimestre desea evaluar a ${grupoActual}, en la materia ${materia.nombre}</h1>

			<g:form action="index" >
				<div class="fieldcontain ${hasErrors(bean: alumnoInstance, field: 'tutor', 'error')} required">
					<g:select id="bimestre" name="bimestre" from="${bimestres}" optionKey="id" required=""/>
				</div>
				<br>
				
				<fieldset class="buttons">
					<g:submitButton name="aceptar" class="save" value="Aceptar" />
				</fieldset>
			</g:form>
